...
2. **Selects** the appropriate tool (`ai_dna_translator` or `ai_species_identifier`).
3. **Executes** the underlying Python/Biopython code.
4. **Synthesizes** the deterministic result into a comprehensive "Laboratory / Crime Scene Report".

## ⚙️ Architecture & Tech Stack

- **The Brain (LLM)**: `Qwen/Qwen2.5-Coder-32B-Instruct` (via Hugging Face Inference API). Chosen for its excellent native "Function Calling" capabilities.
